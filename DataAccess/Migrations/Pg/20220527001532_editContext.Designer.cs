...
namespace DataAccess.Migrations.Pg
{
    ...
    [Migration("20220527001532_editContext")]
            ...
            modelBuilder.Entity("Entities.Concrete.Stock", b =>
                {
                    b.HasOne("Entities.Concrete.Card", "Card")
                        .WithOne("Stock")
                        .HasForeignKey("Entities.Concrete.Stock", "CardId")
            ...
            modelBuilder.Entity("Entities.Concrete.StockOrders", b =>
                {
                    b.HasOne("Entities.Concrete.Card", "Card")
                        .WithOne("StockOrder")
                        .HasForeignKey("Entities.Concrete.StockOrders", "CardId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
